...
function App() {
  ...
  return (
    ...
    >
      ...
      >
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path d="M12 2C6.48 2 2 6.48 2 12c0 1.54.36 3 .97 4.29L2 22l6.05-1.58C9.39 21.61 10.63 22 12 22c5.52 0 10-4.48 10-10S17.52 2 12 2zm0 18c-1.41 0-2.73-.35-3.88-.99l-.28-.15-2.89.76.76-2.89-.15-.28C4.35 14.73 4 13.41 4 12c0-4.41 3.59-8 8-8s8 3.59 8 8-3.59 8-8 8zm4.64-12.14c-.23-.12-1.36-.67-1.57-.75-.21-.07-.36-.12-.52.12-.16.24-.63.75-.77.91-.14.15-.29.17-.52.05-.23-.12-1.07-.39-2.04-1.26-.76-.69-1.27-1.53-1.41-1.76-.14-.23-.02-.35.1-.46.1-.1.23-.25.35-.37.12-.13.16-.22.24-.36.08-.14.04-.27-.02-.38-.06-.1-.52-1.25-.71-1.71-.19-.45-.38-.39-.52-.39-.13 0-.28 0-.42 0-.14 0-.37.05-.56.27-.2.22-.75.73-.75 1.79 0 1.06.77 2.07.88 2.22.11.15 1.55 2.37 3.76 3.32 2.21.96 2.84.77 3.34.72.5-.05 1.62-.66 1.84-1.3.22-.64.22-1.18.15-1.3-.07-.13-.22-.2-.46-.33z" />
        </svg>
      </a>
    </div>
  )
